...
//脚本实现了刚体角色的行走跳跃控制
//参考某js脚本
public class WoShiShaChaV2 : MonoBehaviour {
	public Camera cam;
	public bool canRun=true;
	public bool canJump=true;
	public float inputSpeed=12,runSpeed=24,crouchSpeed=5;//最大的一个方向的速度
	public float inputJumpHeight=7;//跳跃高度
	public float maxAcceleration=20;//最大的一个方向的加速度
	...
	void Start () {
		//theBox = gameObject.GetComponent<BoxCollider> ();
		theCapsule = gameObject.GetComponent<CapsuleCollider> ();
		//height = theCapsule.height;
		//cHeight = theCapsule.height / 2 - theCapsule.radius;
	}
	...
	{
		int frames = 20;
		float scaleChangePerFrame = crouchScale/frames;
		if (!down)
